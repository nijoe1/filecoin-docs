...
- [Developing contracts](smart-contracts/developing-contracts/README.md)
  ...
  - [Verify a contract](smart-contracts/developing-contracts/verify-a-contract.md)
    - [Programmatically](smart-contracts/developing-contracts/verify-a-contract/programmatically/programmatically.md)
      - [Hardhat](smart-contracts/developing-contracts/verify-a-contract/programmatically/hardhat.md)
      - [Foundry](smart-contracts/developing-contracts/verify-a-contract/programmatically/foundry.md)
    - [From the user interface](smart-contracts/developing-contracts/verify-a-contract/explorer-interface/explorer-interface.md)
      - [Filfox](smart-contracts/developing-contracts/verify-a-contract/explorer-interface/filfox.md)
      - [Blockscout](smart-contracts/developing-contracts/verify-a-contract/explorer-interface/blockscout.md)
