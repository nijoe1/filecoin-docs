...
- [Developing contracts](smart-contracts/developing-contracts/README.md)
  ...
  - [Verify a contract](smart-contracts/developing-contracts/verify-a-contract.md)
    - [Programmatic](smart-contracts/developing-contracts/verify-a-contract/programatic/filfox.md)
    - [Explorer Interface](smart-contracts/developing-contracts/verify-a-contract/explorer-interface/filfox.md)
