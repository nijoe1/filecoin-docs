...
- [Developing contracts](smart-contracts/developing-contracts/README.md)
  ...
  - [Verify a contract](smart-contracts/developing-contracts/verify-a-contract.md)
    - [Programmatic](smart-contracts/developing-contracts/verify-a-contract/programatic/programatic.md)
      - [Hardhat](smart-contracts/developing-contracts/verify-a-contract/programatic/hardhat.md)
      - [Foundry](smart-contracts/developing-contracts/verify-a-contract/programatic/foundry.md)
    - [Explorer Interface](smart-contracts/developing-contracts/verify-a-contract/explorer-interface/explorer-interface.md)
